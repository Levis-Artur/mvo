...
export function DataTable({ ariaLabel, columns, headers, rows, loading = false, emptyMessage = 'Дані відсутні.', selectedIndex, onRowClick }: { ariaLabel: string; columns?: DataTableColumn[]; headers?: string[]; rows: React.ReactNode[][]; loading?: boolean; emptyMessage?: string; selectedIndex?: number; onRowClick?: (index: number) => void }) {
