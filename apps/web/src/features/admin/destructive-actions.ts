...
export const DESTRUCTIVE_MODE_DISABLED_MESSAGE = 'Режим видалення тестових даних вимкнений на сервері';
export function canShowDestructiveActions(role?: UserRole) { return role === 'OWNER'; }
export function requiredConfirmation(preview: DeletionPreview, force: boolean) { return force ? preview.displayName : 'ВИДАЛИТИ'; }
